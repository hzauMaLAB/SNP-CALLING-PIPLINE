...
```
###接下来是在作重服务器上的操作
- gvcf合并后提取鸡的不同染色体的vcf（分染色体）  可以用vcftools和bcftools提取，bcftools提取的时候会和原来的文件一模一样，vcftools提取的时候info那一列好像会改变一些信息，这个问题我没有仔细去研究
1.vcftools提取
```
bsub -J chr1 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 1 --recode --stdout | bgzip -c >chicken_chr1.vcf.gz"
bsub -J chr2 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 2 --recode --stdout | bgzip -c >chicken_chr2.vcf.gz"
bsub -J chr3 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 3 --recode --stdout | bgzip -c >chicken_chr3.vcf.gz"
bsub -J chr4 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 4 --recode --stdout | bgzip -c >chicken_chr4.vcf.gz"
bsub -J chr5 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 5 --recode --stdout | bgzip -c >chicken_chr5.vcf.gz"
bsub -J chr6 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 6 --recode --stdout | bgzip -c >chicken_chr6.vcf.gz"
bsub -J chr7 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 7 --recode --stdout | bgzip -c >chicken_chr7.vcf.gz"
bsub -J chr8 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 8 --recode --stdout | bgzip -c >chicken_chr8.vcf.gz"
bsub -J chr9 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 9 --recode --stdout | bgzip -c >chicken_chr9.vcf.gz"
bsub -J chr10 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 10 --recode --stdout | bgzip -c >chicken_chr10.vcf.gz"
bsub -J chr11 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 11 --recode --stdout | bgzip -c >chicken_chr11.vcf.gz"
bsub -J chr12 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 12 --recode --stdout | bgzip -c >chicken_chr12.vcf.gz"
bsub -J chr13 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 13 --recode --stdout | bgzip -c >chicken_chr13.vcf.gz"
bsub -J chr14 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 14 --recode --stdout | bgzip -c >chicken_chr14.vcf.gz"
bsub -J chr15 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 15 --recode --stdout | bgzip -c >chicken_chr15.vcf.gz"
bsub -J chr16 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 16 --recode --stdout | bgzip -c >chicken_chr16.vcf.gz"
bsub -J chr17 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 17 --recode --stdout | bgzip -c >chicken_chr17.vcf.gz"
bsub -J chr18 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 18 --recode --stdout | bgzip -c >chicken_chr18.vcf.gz"
bsub -J chr19 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 19 --recode --stdout | bgzip -c >chicken_chr19.vcf.gz"
bsub -J chr20 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 20 --recode --stdout | bgzip -c >chicken_chr20.vcf.gz"
bsub -J chr21 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 21 --recode --stdout | bgzip -c >chicken_chr21.vcf.gz"
bsub -J chr22 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 22 --recode --stdout | bgzip -c >chicken_chr22.vcf.gz"
bsub -J chr23 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 23 --recode --stdout | bgzip -c >chicken_chr23.vcf.gz"
bsub -J chr24 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 24 --recode --stdout | bgzip -c >chicken_chr24.vcf.gz"
bsub -J chr25 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 25 --recode --stdout | bgzip -c >chicken_chr25.vcf.gz"
bsub -J chr26 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 26 --recode --stdout | bgzip -c >chicken_chr26.vcf.gz"
bsub -J chr27 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 27 --recode --stdout | bgzip -c >chicken_chr27.vcf.gz"
bsub -J chr28 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 28 --recode --stdout | bgzip -c >chicken_chr28.vcf.gz"
bsub -J chr30 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 30 --recode --stdout | bgzip -c >chicken_chr30.vcf.gz"
bsub -J chr31 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 31 --recode --stdout | bgzip -c >chicken_chr31.vcf.gz"
bsub -J chr32 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 32 --recode --stdout | bgzip -c >chicken_chr32.vcf.gz"
bsub -J chr33 -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr 33 --recode --stdout | bgzip -c >chicken_chr33.vcf.gz"
bsub -J chrW -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr W --recode --stdout | bgzip -c >chicken_chrW.vcf.gz"
bsub -J chrZ -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr Z --recode --stdout | bgzip -c >chicken_chrZ.vcf.gz"
bsub -J chrMT -n 1 -R span[hosts=1] -o %J.out -e %J.err -q normal "vcftools --gzvcf combine.vcf.gz --chr MT --recode --stdout | bgzip -c >chicken_chrMT.vcf.gz"
```
2.bcftools提取
```
vi chrMT.region
